<div class="userProfiles index">
	...
	<tbody>
	<?php $b=0;
	foreach ($userProfiles as $userProfile): $b++;?>
	<tr>
		<td><?php echo $b; ?>&nbsp;</td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $userProfile['UserProfile']['id']), array(), __('Are you sure you want to delete # %s?', $userProfile['UserProfile']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
